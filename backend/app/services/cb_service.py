...
class CBService:
    ...
    def _get_cached(self, resident_hash: str) -> Optional[CBScore]:
    ...
    async def _query_nice(
        self, resident_hash: str, applicant_name: Optional[str] = None
    ) -> CBScore:
        """NICE CB API 조회."""
        if not self._client:
    ...
    async def get_dual_cb_score(
    ...
    ) -> tuple[CBScore, Optional[CBScore]]:
        """
        ...
        """
        nice_score: Optional[CBScore] = None
        kcb_score: Optional[CBScore] = None
        ...
        return nice_score or kcb_score, kcb_score

    def conservative_score(self, nice: CBScore, kcb: Optional[CBScore]) -> CBScore:
        """
